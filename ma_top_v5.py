...
import os
os.chdir('/Users/farismismar/Desktop/Appointments/xtr0')
...
dataset = pd.read_csv('../Datasets/No-show-Issue-Comma-300k.csv')
...
data_summary = dataset['Status'].value_counts()
...
try:
    ...
    xtr2 = train2.drop('Status', axis = 1)
    ytr2 = train2['Status']
except:
...
try:
    ...
    xtr3 = train3.drop('Status', axis = 1)
    ytr3 = train3['Status']
except:
...
try:
    ...
    xtr4 = train4.drop('Status', axis = 1)
    ytr4 = train4['Status']
except:
...
try:
    ...
    xtr5 = train5.drop('Status', axis = 1)
    ytr5 = train5['Status']
except:
...
try:
    ...
    xtr6 = train6.drop('Status', axis = 1)
    ytr6 = train6['Status']
except:
    pass
