...
import os
os.chdir('/Users/farismismar/Desktop/Credit Score/xtr0')
...
dataset = pd.read_csv('../Datasets/credit_score.csv')
...
data_summary = dataset['SeriousDlqin2yrs'].value_counts()
...
#train['SeriousDlqin2yrs'] = train['SeriousDlqin2yrs'].replace(['Active', 'Inactive'], [1, 0])
#test['SeriousDlqin2yrs'] = test['SeriousDlqin2yrs'].replace(['Active', 'Inactive'], [1, 0])
...
y_test = test['SeriousDlqin2yrs'].values
...
try:
    ...
    xtr2 = train2.drop('SeriousDlqin2yrs', axis = 1)
    ytr2 = train2['SeriousDlqin2yrs']
except:
...
try:
    ...
    xtr3 = train3.drop('SeriousDlqin2yrs', axis = 1)
    ytr3 = train3['SeriousDlqin2yrs']
except:
...
try:
    ...
    xtr4 = train4.drop('SeriousDlqin2yrs', axis = 1)
    ytr4 = train4['SeriousDlqin2yrs']
except:
...
try:
    ...
    xtr5 = train5.drop('SeriousDlqin2yrs', axis = 1)
    ytr5 = train5['SeriousDlqin2yrs']
except:
...
try:
    ...
    xtr6 = train6.drop('SeriousDlqin2yrs', axis = 1)
    ytr6 = train6['SeriousDlqin2yrs']
except:
    pass
