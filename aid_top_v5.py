...
import os
os.chdir('/Users/farismismar/Desktop/E_Projects/UT Austin Ph.D. EE/Courses/4- Spring 2017/Data Mining/Project/xtr0')
...
train = pd.read_csv('../Datasets/AID373red_train.csv')
test = pd.read_csv('../Datasets/AID373red_test.csv')
...
print('Number of missing values: {}'.format(train.isnull().sum().sum()))

data_summary = train['Outcome'].value_counts()
...
try:
    ...
    xtr2 = train2.drop('Outcome', axis = 1)
    ytr2 = train2['Outcome']
except:
...
try:
    ...
    xtr3 = train3.drop('Outcome', axis = 1)
    ytr3 = train3['Outcome']
except:
...
try:
    ...
    xtr4 = train4.drop('Outcome', axis = 1)
    ytr4 = train4['Outcome']
except:
...
try:
    ...
    xtr5 = train5.drop('Outcome', axis = 1)
    ytr5 = train5['Outcome']
except:
...
try:
    ...
    xtr6 = train6.drop('Outcome', axis = 1)
    ytr6 = train6['Outcome']
except:
